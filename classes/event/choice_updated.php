...
/**
 * The mod_ratingallocate choice_updated.
 *
...
/**
 * The mod_ratingallocate choice_updated event class.
 *
 * @copyright 2017 Davo Smith, Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class choice_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('log_choice_updated', 'mod_ratingallocate');
    }
 
    public function get_description() {
        return "The user with id '$this->userid' has updated the choice with id '$this->objectid' in the Fair allocation ".
